...
st.write("Choose your fruits that you can order in custom Smoothie!")

#option = st.selectbox("What is your favorite fruit?",("Bananna", "Strawberries", "Peaches"))
...
#convert snowpark dataframe to pandas dataframe so u can use loc function
